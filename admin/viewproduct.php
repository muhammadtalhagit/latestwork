...
$view ="SELECT * from `addproduct` as p INNER JOIN `addcategory` as c on p.pcategory = c.id where p.status = '1' ";
$con_view = mysqli_query($connection , $view);

$upload_p = (mysqli_num_rows($con_view) > 0){
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-white">
                                    ...
                                    <tbody>
                                     <?php
                                     while($pro_up = mysqli_fetch_assoc($upload_p)){
                                     ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <img src="<?php echo '..images/' . $pro_up['pimage'];?>" alt=""height="50px" width="50px">
                                            </td>
                                            <?php
                                            if($show['status'] == 1){
                                            ?>
                                            ...
                                            ?>
                                            <td><a href="updatecat.php" class="btn btn-warning">Update</a> 
                                            <a href="deletecat.php" class="btn btn-primary ">Delete</a></td>
                                            <!-- <td>Member</td> -->
                                        </tr>
